...
{
    @BindView(R.id.movement_title_color) View colorView;

    @BindView(R.id.movement_contents_layout) LinearLayout contentsLayout;

    @BindView(R.id.movement_content_scrollview) ScrollView contentScrollView;

    @BindView(R.id.movement_content_a) TextView contentA;
    @BindView(R.id.movement_content_b) TextView contentB;
    @BindView(R.id.movement_content_c) TextView contentC;
    ...
    public void showContents(View v)
    {
        if (contentsLayout.getAlpha() != 1f)
        {
            ...
            HeightAnimation animation = new HeightAnimation(contentsLayout, 0, 50*3);
        ...
        else
        {
            ...
            HeightAnimation animation = new HeightAnimation(contentsLayout, 50*3, 0);
            animation.setInterpolator(new FastOutSlowInInterpolator());
            animation.setDuration(400);
            contentsLayout.startAnimation(animation);
        }
